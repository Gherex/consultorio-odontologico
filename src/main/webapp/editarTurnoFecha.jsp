...
<html lang="en">
    ...
    <div class="container pt-4 w-50" style="min-height: 500px;">
        <form class="user" action="/admin/turnos/editar" method="GET">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="Date" class="form-control form-control-user" id="fecha" name="fecha"
                        placeholder="Fecha" value="<%= tur.getFechaTurno() %>" required>
                </div>
                <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select type="text" class="form-control form-control-user" id="hora" name="hora" required>
                        ...
                        %>
                                <option value="<%= hora %>" <%= tur.getHoraTurno() != null && hora.equals(tur.getHoraTurno()) ? "selected" : "" %> ><%= hora %></option>
                        <%
                            }
                        }
                        %>
